...
The following local inference options require the `NEMOCLAW_EXPERIMENTAL=1` environment variable and do not appear in the selection list during onboarding.
